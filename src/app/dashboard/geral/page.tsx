      ...
      {!loading && data && (
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 auto-rows-min pb-10 mt-6">
          ...
          <div className="col-span-12 md:col-span-4">
            <KpiCard title="Faturamento (R$)" value={formatCurrency(data.kpis.totalFaturamento)} icon={<DollarSign size={18} />} active />
          </div>
          <div className="col-span-6 md:col-span-4">
            <KpiCard title="Fat. Médio" value={formatCurrency(data.kpis.ticketMedio)} icon={<Tags size={18} />} subtitle="Por venda" />
          </div>
          <div className="col-span-6 md:col-span-4">
            <KpiCard title="Qtd. Vendas" value={data.kpis.totalVendas} icon={<Truck size={18} />} />
          </div>

          {/* === LINHA 2: GRÁFICOS === */}
          <div className="col-span-12 lg:col-span-6 h-[350px] bg-card border border-border rounded-xl p-5 flex flex-col relative shadow-sm">
          ...
          <div className="col-span-12 lg:col-span-6 h-[350px] bg-card border border-border rounded-xl p-5 flex flex-col shadow-sm">
            <div className="mb-4">
              <h3 className="text-sm font-bold text-foreground flex items-center gap-2">
